...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        ngconstant: {
            options: {
                name: 'corpDictApp.config.constants',
                ...
                constants: {
                    ...
                    ENV: {
                        'termByIndexUrl': '/cadm/apis/cadm.php?q=',
            ...
            dev: {
                constants: {
                    ENV: {
                        'termByIndexUrl': 'mocks/termMock.json?q=',
        ...
        copy: {
            dist: {
                files: [
                    ...
                    {
                        expand: true,
                        cwd: 'bower_components/snl-common/dist',
                        src: ['styles/**', '!styles/*.css', 'fonts/**'],
                        dest: '<%= config.dist %>'
                    },
                    {
                        expand: true,
                        cwd: 'bower_components/font-awesome/',
                        src: ['fonts/*', 'css/font-awesome.min.css'],
                        dest: '<%= config.dist %>'
                    },
                    {
                        expand: true,
                        cwd: 'bower_components/textAngular/dist/',
                        src: ['textAngular.css', 'textAngular-rangy.min.js', 'textAngular-sanitize.min.js', 'textAngular.min.js', 'textAngularSetup.js'],
